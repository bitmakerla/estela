    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=1000)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='spiders', to='core.project')),
            ],
        ),
        migrations.CreateModel(
            name='SpiderJob',
            fields=[
                ...
                ('spider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobs', to='core.spider')),
            ],
            options={
                'ordering': ['created'],
            },
