                        ...
                        <Content className="lg:m-10 md:mx-6 mx-2">
                            <Row className="flow-root">
                                ...
                                <Col className="float-right flex items-center gap-3">
                                    {memoryQuota > 0 && (
                                        <Tooltip title={`${usedGB} GB used of ${quotaGB} GB quota (${usedPct}%)`}>
                                            <div
                                                role="status"
                                                aria-label={`Memory usage: ${usedPct}% of quota (${usedGB} of ${quotaGB} GB)`}
                                                className="flex items-center gap-2 border border-estela-blue-low bg-white rounded-lg px-3 py-1"
                                            >
