...
export class ProjectListPage extends Component<unknown, ProjectsPageState> {
    ...
    render(): JSX.Element {
        const { projects, loaded, modalNewProject } = this.state;
        const newProject = "";
        return (
                                                ...
                                                <Col>
                                                    ...
                                                    <Col>
                                                        <Row className="text-gray-400">
                                                            ...
                                                            Itaque aliquam reiciendis ea expedita, accusamus inventore
                                                            aspernatur autem sit, nobis, iste hic. Atque rem similique
                                                            quisquam quas impedit ad ab exercitationem?
                                                        </Row>
                                                    </Col>
                                                </Col>
                                            </Row>
