...
import { Row, Space, Select, Button, Tag, Tooltip, Checkbox, Input, Popover, Modal, Form } from "antd";
    ...
    return (
        <div className="lg:m-10 md:mx-6 m-6">
            <Row className="bg-white rounded-lg my-4">
                <p className="text-xl text-silver">Proxy Settings</p>
            </Row>
            <Row>
                <div className="lg:m-8 md:mx-6 m-4">
                    <p className="text-2xl text-estela-black-full text-center">New proxy configuration</p>
                            ...
                            <Form layout="vertical" className="w-96">
                                <div className="">
                                    <Form.Item label="Username" name="proxy_username">
                                        <Input
                                            style={{ fontSize: 14, borderRadius: 8, color: "gray" }}
                                            size="large"
                                            placeholder="Username"
                                            // onChange={this.handleNameChange}
                                            className="border-estela placeholder:text-estela-black-low"
                                        />
                                    </Form.Item>
                                ...
                                <div className="h-12 w-100 button-container">
                                    ...
                                    >
                                        <Link to={`/projects/${projectId}/dashboard`}>Add</Link>
                                    </Button>
                                    <Button
                                        block
                                        // disabled={!detailsChanged}
                                    ...
                                    >
                                        <Link to={`/projects/${projectId}/dashboard`}>Cancel</Link>
                                    </Button>
                                </div>
                            </Form>
                        </Content>
                ...
                <Space direction="vertical" className="lg:m-8 md:mx-6 m-4 w-full">
                    <div className="flex justify-between">
                        <p className="text-2xl text-black">Proxy dadas1</p>
                        <Modal
                            open={openModal}
                            width={400}
