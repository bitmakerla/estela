...
env = environ.Env(
    ...
    DEFAULT_USER_MEMORY_QUOTA=(int, 6144),
...
DEFAULT_USER_MEMORY_QUOTA = env("DEFAULT_USER_MEMORY_QUOTA")
DISPATCH_RETRY_DELAY = env("DISPATCH_RETRY_DELAY")
RUN_JOBS_PER_LOT = env("RUN_JOBS_PER_LOT")
CHECK_JOB_ERRORS_BATCH_SIZE = 100
UPDATE_MONGODB_INSERTION_BATCH_SIZE = 100
MONGODB_MAX_STALLED_CYCLES = 100
...
# MeteredUsageRecord DELTA_SLICE sampling (optional; job-close ledger always dual-writes)
METERED_USAGE_HOURLY_ENABLED = env.bool("METERED_USAGE_HOURLY_ENABLED", default=True)
METERED_USAGE_HOURLY_MAX_JOBS = env.int("METERED_USAGE_HOURLY_MAX_JOBS", default=2000)
METERED_USAGE_STORAGE_HOURLY_ENABLED = env.bool(
    "METERED_USAGE_STORAGE_HOURLY_ENABLED", default=True
)
