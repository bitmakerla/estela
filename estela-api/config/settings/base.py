...
env = environ.Env(
    ...
    SPIDER_JOB_CPU_REQUEST=(str, "100m"),
    SPIDER_JOB_MEM_REQUEST=(str, "128Mi"),
    SPIDER_JOB_CPU_LIMIT=(str, "500m"),
    SPIDER_JOB_MEM_LIMIT=(str, "512Mi"),
...
SPIDER_JOB_CPU_REQUEST = env("SPIDER_JOB_CPU_REQUEST")
SPIDER_JOB_MEM_REQUEST = env("SPIDER_JOB_MEM_REQUEST")
SPIDER_JOB_CPU_LIMIT = env("SPIDER_JOB_CPU_LIMIT")
SPIDER_JOB_MEM_LIMIT = env("SPIDER_JOB_MEM_LIMIT")
