...
class ProxyProviderUpdateSerializer(serializers.Serializer):
    ...
    project_or_spider_id = serializers.CharField(max_length=100, help_text="Project id where the update will be performed")


class ProxyProviderResponseSerializer(serializers.Serializer):
    success = serializers.BooleanField()
    env_vars = SpiderJobEnvVarSerializer(many=True, required=False, help_text="Env vars for the instace(project, spider)")
