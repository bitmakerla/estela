...
sp_db_client = get_database_interface(engine=settings.SPIDERDATA_DB_ENGINE, connection=settings.SPIDERDATA_DB_CONNECTION, production=settings.SPIDERDATA_DB_PRODUCTION, certificate_path=settings.SPIDERDATA_DB_CERTIFICATE_PATH)
